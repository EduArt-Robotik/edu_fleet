...
SPECIALIZE_ATTRIBUTE_ACCESS(x, Attribute::POS_X)
SPECIALIZE_ATTRIBUTE_ACCESS(y, Attribute::POS_Y)
...
SPECIALIZE_ATTRIBUTE_ACCESS(roll, Attribute::ROLL)
SPECIALIZE_ATTRIBUTE_ACCESS(pitch, Attribute::PITCH)
SPECIALIZE_ATTRIBUTE_ACCESS(yaw, Attribute::YAW)
